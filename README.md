...
Jvdroid	Running Java programs on Android
Command Prompt/Terminal	Compiling and executing program
...
File	Represents file path and creates files
FileWriter	Writes data into files
